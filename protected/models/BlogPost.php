...
class BlogPost extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
            array('abbr', 'unique', 'className'=>'BlogPost'),

			array('title, abbr, preview, text', 'required'),
	...
	public function relations()
	{
		...
		return array(
            ...
            'blogTags' => array(self::MANY_MANY, 'BlogTag', 'blog_post_tag(post_id, tag_id)'),
	...
	public function search()
	{
		...
		$criteria->compare('rubrics',$this->rubrics,true);
